...
<section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
    <form method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      @csrf
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input type="text" name="category_slug" id="select-country-input-3" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
                </input>
              ...
              <div>
                ...
                <input type="text" name="description" id="category_desc" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="" required />
                ...
                <tbody>
                  @foreach ($categories as $category)
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                          <img src="{{url('/')}}/images/category/{{$category->category_image}}" alt="" srcset="">
                        </td>
