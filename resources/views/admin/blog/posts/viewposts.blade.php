@extends('admin.layouts.app',['title' => 'Blog Home'])
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <button type="button" id="createProductModalButton" data-modal-target="createProductModal" data-modal-toggle="createProductModal" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-blue-800">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">Post title</th>
                            <th scope="col" class="px-4 py-3">Category slug</th>
                            <th scope="col" class="px-4 py-3">Category name</th>
                            <th scope="col" class="px-4 py-3">Post content</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$post->post_title}}</th>
                            <td class="px-4 py-3">{{$post->post_slug}}</td>
                            <td class="px-4 py-3">{{$post->category->name}}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{$post->post_content}}</td>
                            <td class="px-4 py-3"><img class="w-2/5" src="{{url('/')}}/images/post/{{$post->post_thumbnail}}" alt="" srcset=""></td>
