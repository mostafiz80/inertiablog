    ...
    <ul class="space-y-2">
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                <li>
                    <a href="{{route('users.index')}}"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View all users</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add new user</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Profile</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul id="dropdown-categories" class="hidden py-2 space-y-2">
                <li>
                    <a href="{{route('categories.create')}}"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add new category</a>
                </li>
                <li>
                    <a href="/"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">All categories</a>
                </li>
                <li>
                    <a href="/"
        ...
        <li>
            ...
            <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                ...
                <li>
                    <a href="#"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View all posts</a>
                </li>
                <li>
                    <a href="#"
