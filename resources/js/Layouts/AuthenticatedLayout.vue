            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <li class="mr-3">
                            <Link
                                :href="route('codespace')"
                                :active="route().current('codespace')"
                            >
                                &lt;/CodeSpace&gt;
                            </Link>
                        </li>
    ...
    <div class="container w-full mx-auto pt-20">
        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
            <p class="font-bold text-3xl" v-if="$slots.header">
                <span
                    class="text-blue-500 mx-1 font-extrabold text-4xl relative inline-block stroke-current"
                >
                    <slot name="header" />
                ...
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <div class="block xl:max-w-lg">
                        <a
                            ...
                            class="flex justify-center min-[1124px]:justify-start mb-1"
                        >
                            <img
                                src="/images/logo.png"
                                class="w-1/5"
                        ...
                        <p
                            class="text-lg text-gray-500 mb-4 text-center min-[1124px]:text-left"
                        >
                        ...
                        >
                            <span class="absolute left-5 top-4 lg:top-5"
                                ><svg
                                    width="22"
                                    height="18"
                                    viewBox="0 0 22 18"
            ...
            <div class="py-7 border-t border-gray-200">
                ...
                >
                    <span class="text-sm text-gray-500"
                        >©<a href="https://pagedone.io/">mostafiz.xyz</a> 2024,
