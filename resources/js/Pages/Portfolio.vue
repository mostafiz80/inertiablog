                ...
                >
                    ...
                    >
                        <a href="/project-6">
                            ...
                            />
                            <div
                                class="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-blue-500 to-pink-500 opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"
                            ></div>
                            <div
                                class="p-4 flex flex-col items-center justify-between relative z-10"
                            >
